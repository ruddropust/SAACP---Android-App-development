...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public TaskAdapter(ToDoList context, List<Task> taskList, CreateTaskBottomSheetFragment.setRefreshListener setRefreshListener) {
    ...
    public void showPopUpMenu(View view, int position) {
        ...
        popupMenu.getMenuInflater().inflate(R.menu.to_dolist_menu, popupMenu.getMenu());
    ...
    public void showCompleteDialog(int taskId, int position) {
        Dialog dialog = new Dialog(context, R.style.Theme_SAACPFINAL);
