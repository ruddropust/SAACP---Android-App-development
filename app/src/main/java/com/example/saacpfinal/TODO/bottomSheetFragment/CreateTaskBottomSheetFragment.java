package com.example.saacpfinal.TODO.bottomSheetFragment;
...
public class CreateTaskBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public void setTaskId(int taskId, boolean isEdit, setRefreshListener setRefreshListener, ToDoList activity) {
        this.taskId = taskId;
        this.isEdit = isEdit;
